...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Sidebar visszaszámláló stílusok */
        .countdown-sidebar {
            background: var(--primary);
            color: white;
            padding: 8px 12px;
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($parkolas_naplo as $parkolas): 
                                $status_class = strtotime($parkolas['nidoig']) >= strtotime('today') ? 'status-active' : 'status-inactive';
                                $status_text = strtotime($parkolas['nidoig']) >= strtotime('today') ? 'Aktív' : 'Lejárt';
                            ?>
                            <tr>
